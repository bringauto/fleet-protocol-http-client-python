...
class Car(BaseModel):
    ...
    """ # noqa: E501
    company_name: Annotated[str, Field(strict=True)] = Field(description="Name of the company, following a pattern ^[0-9a-z_]+$")
    car_name: Annotated[str, Field(strict=True)] = Field(description="Name of the Car, following a pattern ^[0-9a-z_]+$")
    __properties: ClassVar[List[str]] = ["company_name", "car_name"]
