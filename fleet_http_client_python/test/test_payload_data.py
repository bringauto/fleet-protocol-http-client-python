...
class TestPayloadData(unittest.TestCase):
    """PayloadData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayloadData:
        """Test PayloadData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayloadData`
        """
        model = PayloadData()
        if include_optional:
            return PayloadData(
